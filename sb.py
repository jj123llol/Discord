...
async def Update_Settings():
    global prefix, others_allowed, watching, whitelisted, afk, consent, gay, pp,Sniper
    time.sleep(.1)
    settings = {
        "prefix": prefix,
...
global prefix, others_allowed, loaded, watching, whitelisted, spam_ping, cmdlists, bot_runner, afk, consent, pp, gay, Sniper
