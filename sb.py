...
async def Update_Settings():
    global prefix, others_allowed, watching, whitelisted, afk, consent, gay, pp
    time.sleep(.1)
    settings = {
        "prefix": prefix,
...
global prefix, others_allowed, loaded, watching, whitelisted, spam_ping, cmdlists, bot_runner, afk, consent, pp, gat
prefix, others_allowed = settings["prefix"], settings["others_allowed"]
afk, gay, pp = settings["afk"],settings["gay"], settings["pp"]
